...
// POST — uwolnienie transzy z rachunku powierniczego na konto MD.
export async function POST(req: NextRequest, { params }: { params: { id: string } }) {
  ...
  const created = await prisma.escrowRelease.create({
    data: {
      accountId: params.id,
      date,
      amount,
      milestone: body.milestone ? String(body.milestone).trim() : null,
