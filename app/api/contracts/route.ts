...
export async function POST(req: NextRequest) {
  ...
  const contract = await prisma.contract.create({
    data: {
      ...
      form: form || null,
      maxReservationFee: maxReservationFee != null && maxReservationFee !== '' ? parseFloat(maxReservationFee) : null,
      reservationFee: reservationFee != null && reservationFee !== '' ? parseFloat(reservationFee) : null,
      maxDiscount: maxDiscount != null && maxDiscount !== '' ? parseFloat(maxDiscount) : null,
      ...
      landSharePrice: landSharePrice != null && landSharePrice !== '' ? parseFloat(landSharePrice) : null,
      salesChance: salesChance != null && salesChance !== '' ? parseInt(salesChance) : null,
