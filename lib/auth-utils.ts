 ...
 * (w layoucie /settings, middleware) jak i po stronie klienta (w Sidebar).
 ...
 *
 * Admin ma override w systemie permissions — zawsze ma wszystko, niezaleznie
 * od wpisu w User.permissions (patrz lib/permissions.ts).
 *
